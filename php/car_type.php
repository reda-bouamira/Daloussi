	...
	<div class="car_type jumbotron pt-4 pb-2 mb-0">
		...
		<div class="d-flex flex-row flex-wrap justify-content-center mt-3">
			<div class="flex-fill p-2 bd-highlight">
				<a href="inventory.php?bodytype=sedan">
					<figure class="figure grow">
						<img class="img-fluid" src="img/car_types/sedan.png">
						<figcaption class="figure-caption text-center">Sedan</figcaption>
					</figure>
				</a>
			</div>
			<div class="flex-fill p-2 bd-highlight">
				<a href="inventory.php?bodytype=hatchback">
					<figure class="figure grow">
			...
			<div class="flex-fill p-2 bd-highlight">
				<a href="inventory.php?bodytype=coupe">
					<figure class="figure grow">
			...
			<div class="flex-fill p-2 bd-highlight">
				<a href="inventory.php?bodytype=minivan">
					<figure class="figure grow">
			...
			<div class="flex-fill p-2 bd-highlight">
				<a href="inventory.php?bodytype=suv">
					<figure class="figure grow">
			...
			<div class="flex-fill p-2 bd-highlight">
				<a href="inventory.php?bodytype=truck">
					<figure class="figure grow">
