...
<ul class="nav justify-content-center bg-dark">
  <li class="nav-item dropdown bg-dark btn-group my_inventory_search_options">
    ...
    <ul class="dropdown-menu my_search_year py-0 mt-0">
      <li class="py-1"><a href="#" class="small" data-value="2018" tabIndex="-1"><input type="checkbox"/>&nbsp;2018</a></li>
      <li class="py-1"><a href="#" class="small py-1" data-value="2017" tabIndex="-1"><input type="checkbox"/>&nbsp;2017</a></li>
      <li class="py-1"><a href="#" class="small py-1" data-value="2016" tabIndex="-1"><input type="checkbox"/>&nbsp;2016</a></li>
      <li class="py-1"><a href="#" class="small" data-value="2015" tabIndex="-1"><input type="checkbox"/>&nbsp;2015</a></li>
      <li class="py-1"><a href="#" class="small" data-value="2014" tabIndex="-1"><input type="checkbox"/>&nbsp;2014</a></li>
      <li class="py-1"><a href="#" class="small" data-value="2013" tabIndex="-1"><input type="checkbox"/>&nbsp;2013</a></li>
    </ul>
  </li>
  <li class="nav-item dropdown bg-dark btn-group my_inventory_search_options">
    ...
    <ul class="dropdown-menu py-0 mt-0">
      <li class="py-1"><a href="#" class="small" data-value="2018" tabIndex="-1"><input type="checkbox"/>&nbsp;Mercedes-benz</a></li>
      <li class="py-1"><a href="#" class="small" data-value="2017" tabIndex="-1"><input type="checkbox"/>&nbsp;BMW</a></li>
      <li class="py-1"><a href="#" class="small" data-value="2016" tabIndex="-1"><input type="checkbox"/>&nbsp;Audi</a></li>
      <li class="py-1"><a href="#" class="small" data-value="2015" tabIndex="-1"><input type="checkbox"/>&nbsp;Volkswagen</a></li>
      <li class="py-1"><a href="#" class="small" data-value="2014" tabIndex="-1"><input type="checkbox"/>&nbsp;Fiat</a></li>
      <li class="py-1"><a href="#" class="small" data-value="2013" tabIndex="-1"><input type="checkbox"/>&nbsp;Dacia</a></li>
    </ul>
  </li>
  <li class="nav-item dropdown bg-dark btn-group my_inventory_search_options">
  ...
  <li class="nav-item dropdown bg-dark btn-group my_inventory_search_options">
    ...
    <ul class="dropdown-menu py-0 mt-0">
      <li class="py-1"><a href="#" class="small" data-value="2018" tabIndex="-1"><input type="checkbox"/>&nbsp;Automatic</a></li>
      <li class="py-1"><a href="#" class="small" data-value="2017" tabIndex="-1"><input type="checkbox"/>&nbsp;Manual</a></li>
    </ul>
  </li>
  </li>
  <li class="nav-item dropdown bg-dark btn-group my_inventory_search_options">
    ...
    <ul class="dropdown-menu py-0 mt-0">
      <li><a href="#" class="small" data-value="2018" tabIndex="-1"><input type="checkbox"/>&nbsp;Gasoline</a></li>
      <li><a href="#" class="small" data-value="2017" tabIndex="-1"><input type="checkbox"/>&nbsp;Diesel</a></li>
      <li><a href="#" class="small" data-value="2016" tabIndex="-1"><input type="checkbox"/>&nbsp;Hybrid</a></li>
    </ul>
  </li>
  <li class="nav-item dropdown bg-dark btn-group my_inventory_search_options">
